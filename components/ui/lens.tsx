...
export const Lens = ({
  ...
  const hovering =
    customHovering !== undefined ? customHovering : localHovering;
  const setHovering = customSetHovering || setLocalHovering;
          ...
          <motion.div
            ...
            style={{
              maskImage: `radial-gradient(circle ${lensSize / 2}px at ${
                (customPosition || mousePosition).x
              }px ${
                (customPosition || mousePosition).y
          ...
          >
            <div
              ...
              style={{
                ...
                transformOrigin: `${(customPosition || mousePosition).x}px ${
                  (customPosition || mousePosition).y
                }px`,
              }}
            >
